            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="500ms">
                        <div class="popular-course-content">
                            <h5><b>Collge of Commerece</b></h5>
                            <hr>
                            <p>Taking guides in accounting, finance, economics, actuarial studies, commercial enterprise management, human sources and marketing; 
                                a few applications additionally require commercial enterprise statistics and -calculus, and data systems.</p>
                            <a href="#" class="btn academy-btn btn-sm">See More</a>
                        </div>
